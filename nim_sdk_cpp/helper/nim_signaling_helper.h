...
/** @struct SignalingNotityInfo
* @brief 事件通知信息基类
* @note 事件对应的通知说明\n
* kNIMSignalingEventTypeClose	返回SignalingNotityInfoClose，支持在线、离线通知\n
* kNIMSignalingEventTypeJoin	返回SignalingNotityInfoJoin，支持在线、离线通知\n
* kNIMSignalingEventTypeInvite	返回SignalingNotityInfoInvite，支持在线、离线通知\n
* kNIMSignalingEventTypeCancelInvite	返回SignalingNotityInfoCancelInvite，支持在线、离线通知\n
* kNIMSignalingEventTypeReject	返回SignalingNotityInfoReject，支持在线、多端同步、离线通知\n
* kNIMSignalingEventTypeAccept	返回SignalingNotityInfoAccept，支持在线、多端同步、离线通知\n
* kNIMSignalingEventTypeLeave	返回SignalingNotityInfoLeave，支持在线、离线通知\n
* kNIMSignalingEventTypeCtrl	返回SignalingNotityInfoControl，支持在线通知
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfo
{
	...
	*/
	static std::shared_ptr<SignalingNotityInfo> GetSharedPtr(const NIMSignalingNotityInfo* c_info);
};

/** @struct SignalingNotityInfoClose
*	@brief 频道关闭事件通知信息，event_type_=kNIMSignalingEventTypeClose
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoClose : SignalingNotityInfo
{
};

/** @struct SignalingNotityInfoJoin
*	@brief 加入频道事件通知信息，event_type_=kNIMSignalingEventTypeJoin
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoJoin : SignalingNotityInfo
{
	SignalingMemberInfo member_;	/**< 加入成员的信息，用于获得uid */
};

/** @struct SignalingNotityInfoInvite
*	@brief 邀请事件通知信息，event_type_=kNIMSignalingEventTypeInvite
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoInvite : SignalingNotityInfo
{
...
/** @struct SignalingNotityInfoCancelInvite
*	@brief 取消邀请事件通知信息，event_type_=kNIMSignalingEventTypeCancelInvite
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoCancelInvite : SignalingNotityInfo
{
	std::string to_account_id_;		/**< 被邀请者的账号 */
	std::string request_id_;		/**< 邀请者邀请的请求id */
};
/** @struct SignalingNotityInfoReject
*	@brief 拒绝邀请事件通知信息，event_type_=kNIMSignalingEventTypeReject
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoReject : SignalingNotityInfo
{
	std::string to_account_id_;	/**< 邀请者的账号 */
	std::string request_id_;	/**< 邀请者邀请的请求id */
};
/** @struct SignalingNotityInfoAccept
*	@brief 接收邀请事件通知信息，event_type_=kNIMSignalingEventTypeAccept
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoAccept : SignalingNotityInfo
{
	std::string to_account_id_;		/**< 邀请者的账号 */
	std::string request_id_;		/**< 邀请者邀请的请求id */
};

/** @struct SignalingNotityInfoLeave
*	@brief 退出频道事件通知信息，event_type_=kNIMSignalingEventTypeLeave
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoLeave : SignalingNotityInfo
{
};

/** @struct SignalingNotityInfoControl
*	@brief 控制事件通知信息，event_type_=kNIMSignalingEventTypeCtrl
*/
struct NIM_SDK_CPPWRAPPER_DLL_API SignalingNotityInfoControl : SignalingNotityInfo
{
};
